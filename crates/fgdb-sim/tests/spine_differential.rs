...
#[test]
fn strata_batch_inode_sync_lie_fences_before_root_publication() {
    let dir = scratch("database-batch-inode-lie");
...
#[test]
fn strata_batch_directory_barrier_is_required_for_receipts_and_names() {
