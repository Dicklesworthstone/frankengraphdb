...
impl<F, C, P, Row: GlaOutput> Execution<F, C, P, Row> {
    ...
    where F: FnMut(VId, &[VertexPredicate]) -> Result<bool, E>, C: FnMut(GlaExecutionEvent) -> Result<(), E>,
        ...
        match operator {
            ...
            GlaOperator::Project { .. } | GlaOperator::ProjectBindings { .. } | GlaOperator::ProjectValues { .. } => {
            ...
            | GlaOperator::OrderByValues | GlaOperator::Limit { .. } => {}
        }
        Ok(())
    }
}
...
impl<Row: GlaIdentityOutput> GlaPlan<Row> {
    ...
    pub fn execute_with_control<E>(&self, vertices: impl IntoIterator<Item = VId>,
        ...
        control: impl FnMut(GlaExecutionEvent) -> Result<(), E>) -> Result<Vec<Row>, E> {
        self.execute_projected(vertices, edges, test_vertex, control,
            |operator, bindings, projected, control| Row::collect(operator, bindings, projected, control))
    }
}
...
impl<Row: GlaOutput> GlaPlan<Row> {
    ...
    fn execute_projected<E, F, C, P>(&self, vertices: impl IntoIterator<Item = VId>,
        edges: impl IntoIterator<Item = (VId, RelationId, VId)>,
