...
/// reproducible from the same inputs certifies nothing.
#[test]
fn same_inputs_yield_an_identical_certificate() {
    under_lab(0x9c_01, |cx| async move {
        ...
        let first = db
            .gql_plan_certificate(PINNED, &bind_to(R1))
...
fn a_different_bound_relation_changes_the_digest() {
    under_lab(0x9c_03, |cx| async move {
        ...
        let bound_r2 = db
            .gql_plan_certificate(PINNED, &bind_to(R2))
