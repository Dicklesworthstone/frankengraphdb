...
impl<V: Vfs + Clone> Database<V> {
    ...
    /// and plain DELETE. A later statement observes preceding checked effects;
    ...
    /// MERGE and upsert variants are explicitly refused during whole-program
    /// preflight, before any database read, pin or identity reservation. Their
    /// privileged existence/uniqueness paths are NEVER used as an auth fallback.
