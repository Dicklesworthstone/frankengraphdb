...
pub const PINNED_BEAD_COUNT: usize = 309;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 165;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:ae3dac305681a720";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:5d7e1869cfb19af7";
