...
pub const PINNED_BEAD_COUNT: usize = 337;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:871e7cef265fff85";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:db452ee0cdf3025d";
