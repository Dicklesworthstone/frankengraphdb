...
pub const PINNED_BEAD_COUNT: usize = 336;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 187;
pub const PINNED_EXACT_OVERRIDE_COUNT: usize = 13;
pub const PINNED_FAMILY_RULE_COUNT: usize = 35;
pub const PINNED_BEAD_FAMILY_TABLE_COUNT: usize = 14;
pub const PINNED_BEAD_OVERRIDE_TABLE_COUNT: usize = 13;
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:a718a5930496dde1";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:a563bd2bd6b3af4b";
