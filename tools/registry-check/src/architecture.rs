...
pub const PINNED_BEAD_COUNT: usize = 333;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 184;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:bffbfd72aeecc700";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:45e9bae70739a3b8";
