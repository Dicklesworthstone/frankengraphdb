...
pub const PINNED_BEAD_COUNT: usize = 398;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 243;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:fe035bf5fa493626";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:db71fd98c4ab5a60";
