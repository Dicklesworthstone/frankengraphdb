...
pub const PINNED_BEAD_COUNT: usize = 377;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 222;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:69ea82a76631059b";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:7397bedecbab51d2";
