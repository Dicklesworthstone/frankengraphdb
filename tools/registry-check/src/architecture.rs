...
pub const PINNED_BEAD_COUNT: usize = 306;
pub const PINNED_DIRECT_OWNER_COUNT: usize = 98;
pub const PINNED_BET_LABEL_COUNT: usize = 162;
...
pub const PINNED_BEAD_BINDING_HASH: &str = "fnv1a64:ee91127f8697ea58";
...
pub const PINNED_SEMANTIC_CONTRACT_HASH: &str = "fnv1a64:593cd590233232a8";
