...
pub const EXPECTED_EXISTING_TYPE_RESERVATION_COUNT: usize = 238;
pub const EXPECTED_RESERVED_TYPE_RESERVATION_COUNT: usize = 575;
pub const EXPECTED_RESERVATION_HIGH_WATER: u16 = 0x051d;
pub const EXPECTED_RESERVATION_ASSIGNMENT_SHA256: &str =
    "b3d2129b227701d5e83c9e36fa7341ef2a728197f47925f3db2bdd755afa457b";
