...
|---|---|---|---|---|---|
| asupersync | linked | `90685fbe13aa88f679d8e212d814a995b520a5a1` | `asupersync` | must be disabled (workspace_convention_unanimous) | §2.1 |
...
* `semantic_contract_hash` = `fnv1a64:38088f401c692548` — every normative decision, prose excluded.
