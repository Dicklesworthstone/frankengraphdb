...
|---|---|---|---|---|---|
| asupersync | linked | `24eb7ec6c62e9ba037d70fed4a69c4e733785926` | `asupersync` | must be disabled (workspace_convention_unanimous) | §2.1 |
...
* `semantic_contract_hash` = `fnv1a64:510d1b3de5d772f7` — every normative decision, prose excluded.
