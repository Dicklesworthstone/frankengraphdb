...
|---|---|---|---|---|---|
| asupersync | linked | `3b34c9b0a14c55eb814cf4aaeceeba3be0c0a72e` | `asupersync` | must be disabled (workspace_convention_unanimous) | §2.1 |
...
* `semantic_contract_hash` = `fnv1a64:b87cb355fab8bcd8` — every normative decision, prose excluded.
