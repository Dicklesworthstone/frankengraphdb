...
* **Layers:** 14
* **Crates:** 70 (10 active, 59 planned, 1 reserved)
...
| # | Crate | Status | Unsafe | Posture | Owner | Bead | Role |
|---|---|---|---|---|---|---|---|
| 1 | `fgdb-unsafe-simd` | planned | `deny_ledgered` | all | W1 | fgdb-w1-unsafe-ledger-icp | SIMD/vector kernels with bit-identical scalar fallbacks. |
| 2 | `fgdb-unsafe-arena` | planned | `deny_ledgered` | all | W1 | fgdb-w1-unsafe-ledger-icp | Bump/region arena internals and generational-handle plumbing behind safe APIs. |
...
| # | Crate | Status | Unsafe | Posture | Owner | Bead | Role |
|---|---|---|---|---|---|---|---|
| 1 | `fgdb-gql` | planned | `forbid` | all | W5 | fgdb-w5-parsers-nje | syntax only |
...
| # | Crate | Status | Unsafe | Posture | Owner | Bead | Role |
|---|---|---|---|---|---|---|---|
| 1 | `fgdb-sim` | planned | `forbid` | test_only | W1 | fgdb-verif-sim-q97e | The whole database under the lab runtime: virtual time, DPOR, chaos, crashpacks. |
| 2 | `fgdb-reference` | planned | `forbid` | test_only | W1 | fgdb-verif-reference-3kkp | executable semantics oracle |
...
|---|---|---|---|---|---|
| asupersync | linked | `e464a484cb65c1a55be0d9c925e6e9c20318edcb` | `asupersync` | must be disabled (workspace_convention_unanimous) | §2.1 |
...
* `semantic_contract_hash` = `fnv1a64:06dc3e04b7b7a0ca` — every normative decision, prose excluded.
