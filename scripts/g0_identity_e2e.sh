...
if jsonl_line_has_all "$WORK/appendix-baseline.jsonl" \
    ...
    '"target_source_assignment_sha256":"78a5c3bf658975ab7878c97caf581a8902b3a8035a2023f2275c6971401cb25d"' \
    '"outcome":"pass"'; then
...
awk '
  !changed && $0 == "registry_epoch = 7" {
    print "registry_epoch = 8"
    changed = 1
    next
  }
  { print }
