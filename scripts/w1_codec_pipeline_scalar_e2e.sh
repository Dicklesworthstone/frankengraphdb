...
grep -Fqx 'asupersync = { git = "https://github.com/Dicklesworthstone/asupersync", rev = "24eb7ec6c62e9ba037d70fed4a69c4e733785926", default-features = false }' crates/fgdb-codec/Cargo.toml
...
grep -Fq 'git+https://github.com/Dicklesworthstone/asupersync?rev=24eb7ec6c62e9ba037d70fed4a69c4e733785926#24eb7ec6c62e9ba037d70fed4a69c4e733785926' Cargo.lock
...
EXPECTED_DIRECT="$(
  printf '%s\t%s\t%s\t%s\n' \
    'asupersync' 'normal' 'git+https://github.com/Dicklesworthstone/asupersync?rev=24eb7ec6c62e9ba037d70fed4a69c4e733785926' '' \
