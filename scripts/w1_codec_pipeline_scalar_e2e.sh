...
grep -Fqx 'asupersync = { git = "https://github.com/Dicklesworthstone/asupersync", rev = "78b64636e99fea4ea2d868096576021dd3b8e519", version = "=0.5.0", default-features = false }' crates/fgdb-codec/Cargo.toml
...
grep -Fq 'git+https://github.com/Dicklesworthstone/asupersync?rev=78b64636e99fea4ea2d868096576021dd3b8e519#78b64636e99fea4ea2d868096576021dd3b8e519' Cargo.lock
...
EXPECTED_DIRECT="$(
  printf '%s\t%s\t%s\t%s\n' \
    'asupersync' 'normal' 'git+https://github.com/Dicklesworthstone/asupersync?rev=78b64636e99fea4ea2d868096576021dd3b8e519' '' \
