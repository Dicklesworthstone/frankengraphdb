...
grep -Fqx 'asupersync = { git = "https://github.com/Dicklesworthstone/asupersync", rev = "3b34c9b0a14c55eb814cf4aaeceeba3be0c0a72e", default-features = false }' crates/fgdb-codec/Cargo.toml
...
grep -Fq 'git+https://github.com/Dicklesworthstone/asupersync?rev=3b34c9b0a14c55eb814cf4aaeceeba3be0c0a72e#3b34c9b0a14c55eb814cf4aaeceeba3be0c0a72e' Cargo.lock
...
EXPECTED_DIRECT="$(
  printf '%s\t%s\t%s\t%s\n' \
    'asupersync' 'normal' 'git+https://github.com/Dicklesworthstone/asupersync?rev=3b34c9b0a14c55eb814cf4aaeceeba3be0c0a72e' '' \
