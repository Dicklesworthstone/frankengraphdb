...
grep -Fqx 'asupersync = { git = "https://github.com/Dicklesworthstone/asupersync", rev = "3e8d08efe6617e08635fa8705c62a2a531373f43", default-features = false }' crates/fgdb-codec/Cargo.toml
...
grep -Fq 'git+https://github.com/Dicklesworthstone/asupersync?rev=3e8d08efe6617e08635fa8705c62a2a531373f43#3e8d08efe6617e08635fa8705c62a2a531373f43' Cargo.lock
...
EXPECTED_DIRECT="$(
  printf '%s\t%s\t%s\t%s\n' \
    'asupersync' 'normal' 'git+https://github.com/Dicklesworthstone/asupersync?rev=3e8d08efe6617e08635fa8705c62a2a531373f43' '' \
